    ...
    <div className="min-h-screen bg-white py-12 px-4 md:px-40">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Image */}
          <div className="relative w-full lg:col-span-5 aspect-[4/5] overflow-hidden rounded-2xl bg-gray-100 shadow-lg">
            <Image
            ...
            {activeTab === "bullying" && (
              <>
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Through interactive workshops and engaging activities, we
                    teach children how to identify bullying behavior, stand up
                    for themselves and others, and navigate the digital world
                    safely. We equip them with practical strategies to protect
