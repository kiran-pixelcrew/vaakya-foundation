...
import mobileHero from "../../../public/mobileHero.png";
...
export const Hero = () => {
  return (
    <>
      {/* Desktop Version */}
      <motion.section
        className="relative overflow-hidden hidden md:flex items-center justify-start h-screen mt-20 px-4 sm:px-8 md:px-12 lg:px-40"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
