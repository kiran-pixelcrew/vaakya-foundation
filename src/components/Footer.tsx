...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1a1a1a] text-white py-12 px-4 md:px-40">
      <div className="w-full">
        {/* First Row: Logo, Social Media (centered), and Navigation Links */}
        <div className="relative flex flex-col md:flex-row items-start justify-between gap-8 md:gap-12">
          {/* Logo - Left */}
          ...
          <div className="w-full md:w-auto md:flex-grow md:flex md:justify-end">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 lg:gap-12">
              {footerSections.map((section, index) => (
                <div key={index}>
                  <h3 className="text-[#FFD45C] text-lg font-semibold mb-4">
                    {section.title}
                  </h3>
                  <ul className="space-y-2">
                    {section.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <Link
                          href={link.href}
                          className="text-gray-300 hover:text-[#FFD45C] transition-colors duration-200 text-sm"
                        >
                          {link.name}
                        </Link>
                      </li>
